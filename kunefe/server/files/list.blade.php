                ...
                <thead>
                    <tr>
                        <th class="middle min-size">
                            <input type="checkbox" class="select-all-files hidden-xs" data-action="selectAll"><i class="fas fa-sync-alt muted muted-hover use-pointer" data-action="reload-files" style="font-size:14px; margin-left: 10px;"></i>
                        </th>
